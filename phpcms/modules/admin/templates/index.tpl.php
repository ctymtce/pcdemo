...
<link href="<?=BS_PATH?>/css/bootstrap.css" rel="stylesheet" type="text/css" />
<link href="<?=BS_PATH?>/css/bootstrap-responsive.css" rel="stylesheet" type="text/css" />
<link href="<?=BS_PATH?>/css/docs.css" rel="stylesheet" type="text/css" />
    ...
    <div class="col-auto">
        ...
        <li>
            <div class="btn-group" style="margin-top:5px;">
              <button data-toggle="dropdown" class="btn btn-success dropdown-toggle"><?=$currentsite['name']?><span class="caret"></span></button>
              <ul class="dropdown-menu">
                <li><a href="#">Action</a></li>
                <li><a href="javascript:;"><span><?php echo $currentsite['name']?></span></a></li>
...
<div id="content" class="container-fluid">
    ...
    <div class="span9" id="display_center_id" style="display:none" height="100%">
        <div class="hero-unit" style="border:1px solid #f00;">
